...
void ProjectOne::setup()
{
    ...
    //agents->create_behavior_agent("ExampleAgent2", BehaviorTreeTypes::Example);

    BehaviorAgent* combatant1 = agents->create_behavior_agent("Combatant", BehaviorTreeTypes::TestCombatant);
    BehaviorAgent* combatant2 = agents->create_behavior_agent("Combatant", BehaviorTreeTypes::TestCombatant);
    combatant1->set_movement_speed(agents->GetRPSCombatantBaseSpeed());
    combatant2->set_movement_speed(agents->GetRPSCombatantBaseSpeed());

    BehaviorAgent* spectator1 = agents->create_behavior_agent("Spectator", BehaviorTreeTypes::RPSScardeySpectator);
    BehaviorAgent* spectator2 = agents->create_behavior_agent("Spectator", BehaviorTreeTypes::RPSScardeySpectator);


    BehaviorAgent* cop1 = agents->create_behavior_agent("Cop", BehaviorTreeTypes::RPSCop);
